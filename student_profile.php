...
if (isset($_POST['update_profile'])) {
    ...
    $checkEmailQuery = "SELECT * FROM user WHERE email = '$s_email' AND Username != '$name'";
    $checkEmailResult = mysqli_query($data, $checkEmailQuery);

    if (mysqli_num_rows($checkEmailResult) > 0) {
        echo "<script type='text/javascript'>
            alert('Email is already taken. Please try another email.');
            </script>";
    } else {
            ...
            <form action="#" method="POST">
                ...
                <div class="div_deg">
                    ...
                    <div>
                        ...
                        <input type="submit" class="btn btn-primary" name="update_profile" value="update" id="">
                    </div>
